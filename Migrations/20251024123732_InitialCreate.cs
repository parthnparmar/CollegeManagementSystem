        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Email = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    AttendancePercent = table.Column<double>(type: "float", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AttendanceSummaries_Courses_CourseId",
                        column: x => x.CourseId,
                        principalTable: "Courses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AttendanceSummaries_Students_StudentId1",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AttendanceSummaries_CourseId",
                table: "AttendanceSummaries",
                column: "CourseId");

            migrationBuilder.CreateIndex(
                name: "IX_AttendanceSummaries_StudentId1",
                table: "AttendanceSummaries",
                column: "StudentId1");
